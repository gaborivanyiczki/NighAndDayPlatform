                                ...
                                <div class="collection-product-wrapper">
                                    <div class="product-wrapper-grid">
                                        <div class="row">
                                            ...
                                            @foreach (json_decode($step->getSponges(), true) as $item)
                                                <div class="col-lg-2 col-md-6 col-grid-box">
                                                    <div class="product-box">
                                                        ...
                                                        <div class="product-detail">
                                                            <div>
                                                                <h6>{{ $item['Name'] }}</h6>
                                                                <input id="configurator_sponge" type="radio" name="configurator_sponge" value="{{ $item['id'] }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
