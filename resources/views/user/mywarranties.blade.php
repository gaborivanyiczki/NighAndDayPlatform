            ...
            <div class="col-sm-6">
                <nav aria-label="breadcrumb" class="theme-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Garantii</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<section class="section-b-space">
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
                <div class="account-sidebar"><a class="popup-btn">Garantii</a></div>
                    ...
                    <div class="dashboard">
                        ...
                        <div class="block-content">
                            <ul>
                                ...
                                <li class="active"><a href="#">Garantiile mele</a></li>
