...
<section class="about-page section-b-space" style="background-color: white;">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="banner-section" style="margin-bottom: 30px;"><img src="{{ URL::to('/') }}/images/about/about%20us.jpg" class="img-fluid blur-up lazyload" alt=""></div>
            </div>
            <div class="col-sm-12">
                <h4>Scurt istoric, Filosofia & Misiunea noastra</h4>
                <p> SC. 4 BRANDS SRL şi-a început activitatea în anul 2011, având un număr de 30 de angajaţi. Prima activitate a firmei a fost prelucrarea de spume poliuretanice.

                    La scurt timp a început producţia de perne (perne decor, perne de dormit simple sau memory de diferite dimensiuni) lărgindu-se gama de producţie şi numărul de angajaţi. Cea mai recentă activitate a firmei o reprezintă producţia de saltele pentru confortul personal al clienţilor noştri sau pentru diferite instituţii publice (spitale, gradiniţe şi altele), acestea fiind fabricate conform standardelor europene.

                    Personalul firmei noastre oferă consultanţă profesionistă în informarea şi alegerea produsului potrivit pentru fiecare client. În funcţie de cerinţele dumneavostră se realizează modelul de produs personalizat.

                    Întrucât opinia clienţilor noştri este foarte importantă pentru noi, personalul firmei se străduieşte să realizeze produse de cea mai bună calitate, astfel încât sunt puse la dispoziţie produse diversificate, păstrându-se realitatea pieţei şi raportul calitate-preţ.
                </p>
                <p>
                    Filosofia firmei este aceea de a creşte calitatea vieţii cu ajutorul produselor oferite. Pentru ca scopul să fie atins, se au în vedere producerea articolelor cu design inovativ şi găsirea soluţiilor practice, îmbunătăţindu-se CALITATEA şi CONFORTUL.
                </p>
                <p>
                    Misiunea firmei este de a găsi o organizaţie profitabilă, avându-se în vedere o îmbunătăţire continuă, fiind deschişi DEZVOLTĂRII şi atenţi la NEVOILE CLIENŢILOR.
                </p>
                </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="team-4">
                    <div>
                        <div>
                            <img src="{{ URL::to('/') }}/images/team/1.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                        </div>
                        <h4>Andrei Pop</h4>
                        <h6>CEO & Fondator</h6>
                    </div>
                    <div>
                        <div>
                            <img src="{{ URL::to('/') }}/images/team/2.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                        </div>
                        <h4>Vasile Pop</h4>
                        <h6>CEO & Fondator</h6>
                    </div>
                    <div>
                        <div>
                            <img src="{{ URL::to('/') }}/images/team/3.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                        </div>
                        <h4>Mihai Pop</h4>
                        <h6>Designer</h6>
                    </div>
                    <div>
                        <div>
                            <img src="{{ URL::to('/') }}/images/team/4.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                        </div>
                        <h4>Antonia Pop</h4>
                        <h6>Relatii cu clientii</h6>
                    </div>
                    <div>
                        <div>
                            <img src="{{ URL::to('/') }}/images/team/1.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
