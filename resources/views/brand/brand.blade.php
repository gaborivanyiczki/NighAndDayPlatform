...
<section class="about-page section-b-space">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="banner-section"><img src="{{ URL::to('/') }}/images/uploads/{!! $brandModel['brand']['BannerPath'] !!}/{!! $brandModel['brand']['BannerFile'] !!}" class="img-fluid blur-up lazyload" alt=""></div>
            </div>
            <div class="col-sm-12">
                <h4>{!! $brandModel['brand']['Name'] !!}</h4>
                <p>{!! $brandModel['brand']['Description'] !!}</p>
            </div>
        </div>
    </div>
</section>
