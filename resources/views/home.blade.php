    ...
    <div class="container absolute-bg">
        <div class="service p-0 ">
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6 service-block">
                    <div class="media">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 480 480" style="enable-background:nou 0 0 480 480;" xml:space="preserve" width="512px" height="512px">
                            <g>
	                            <g>
		                            <g>
                ...
                <div class="col-lg-3 col-sm-6 service-block">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>oferte personalizate in functie de cerinte</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 service-block">
                    <div class="media">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:nou 0 0 512 512;" xml:space="preserve" width="512px" height="512px">
                   <g>
	                  <g>
                          <g>
                        ...
                        <div class="media-body">
                            ...
                            <p>descopera toate optiunile de plata</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <div class="title3">
                    <h4>despre noi</h4>
                    <h2 class="title-inner3">bine ati venit pe Night & Day</h2>
                    <div class="line"></div>
                </div>
                <div class="about-text">
                    <p>Filosofia firmei este aceea de a creşte calitatea vieţii cu ajutorul produselor oferite. Pentru ca scopul să fie atins, se au în vedere producerea articolelor cu design inovativ şi găsirea soluţiilor practice, îmbunătăţindu-se CALITATEA şi CONFORTUL.
                    Personalul firmei noastre oferă consultanţă profesionistă în informarea şi alegerea produsului potrivit pentru fiecare client. În funcţie de cerinţele dumneavostră se realizează modelul de produs personalizat.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="container category-button">
    <section class="section-b-space border-section">
        <div class="row partition1">
            <div class="col"><a href="#" class="btn btn-outline btn-block">tehnologie 1</a></div>
            <div class="col"><a href="#" class="btn btn-outline btn-block">tehnologie 2</a></div>
            <div class="col"><a href="#" class="btn btn-outline btn-block">tehnologie 3</a></div>
            <div class="col"><a href="#" class="btn btn-outline btn-block">tehnologie 4</a></div>
            <div class="col"><a href="#" class="btn btn-outline btn-block">tehnologie 5</a></div>
            <div class="col"><a href="#" class="btn btn-outline btn-block">tehnologie 6</a></div>
        </div>
    </section>
</div>
<!-- category end -->
                                ...
                                <div class="product-box">
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <a href="product-page(no-sidebar).html">
                                            <h6>Saltea Tehnologie 2 - 200x160</h6>
                                        </a>
                                        <h4>500.00 Lei <del>600.00 Lei</del></h4>
                ...
                <div class="product-5 product-m no-arrow">
                    <div class="product-box product-wrap">
                        <div class="img-wrapper">
                            ...
                            <div class="front">
                                <a href="#"><img alt="" src="../assets/images/tools/pro/1.jpg" class="img-fluid blur-up lazyload bg-img" ></a>
                            </div>
                            <div class="cart-info cart-wrap">
                        ...
                        <div class="product-info">
                            ...
                            <a href="product-page(no-sidebar).html"><h6>Saltea Tehnologie 1 - 200x160</h6></a>
                            <h4>500.00 lei</h4>
                        </div>
                    </div>
                    <div class="product-box product-wrap">
