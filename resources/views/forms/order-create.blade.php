<form action="{{isset($route)?$route:route('dashboard.orders.store')}}" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control {{ $errors->has('Address') ? ' is-invalid' : '' }}" name="Address" id="Address" value="" placeholder="" maxlength="255" required="required" >
    ...
    <div class="form-group">
        <div class="form-row">
            <div class="col">
                ...
                <input type="text" class="form-control {{ $errors->has('ZipCode') ? ' is-invalid' : '' }}" name="ZipCode" id="ZipCode" value="" placeholder="" maxlength="255" required="required" >
            ...
            <div class="col">
                ...
                <input type="text" class="form-control {{ $errors->has('Telephone') ? ' is-invalid' : '' }}" name="Telephone" id="Telephone" value="" placeholder="" maxlength="255" required="required" >
    ...
    <div class="form-group">
        <div class="form-row">
            <div class="col">
                ...
                <input type="text" class="form-control {{ $errors->has('Email') ? ' is-invalid' : '' }}" name="Email" id="Email" value="" placeholder="" maxlength="255" required="required" >
                @if($errors->has('Email'))
                    <div class="invalid-feedback">
            ...
            <div class="col">
                ...
                <input type="text" class="form-control {{ $errors->has('ContactName') ? ' is-invalid' : '' }}" name="ContactName" id="ContactName" value="" placeholder="" maxlength="255" required="required" >
    ...
    <h5 class="font-weight-bold" style="border-bottom: 2px solid #c5c0c0;margin-bottom:20px;">Date comanda</h6>
        ...
        <div class="form-row">
            <div class="col-sm-6">
                ...
                <div class="input-group">
                    <input type="ShipCharge" class="form-control {{ $errors->has('ShipCharge') ? ' is-invalid' : '' }}" name="ShipCharge" id="ShipCharge" value="" placeholder="" maxlength="255" >
    ...
    <div class="form-group">
        <div class="form-row">
            <div class="col-xs-6">
                ...
                <div class="input-group">
                    <input type="TotalValue" class="form-control {{ $errors->has('TotalValue') ? ' is-invalid' : '' }}" name="TotalValue" id="TotalValue" value="" placeholder="" maxlength="255" >
                    <div class="input-group-append">
                        <span class="input-group-text" id="inputGroupPrepend">Lei</span>
                    </div>
