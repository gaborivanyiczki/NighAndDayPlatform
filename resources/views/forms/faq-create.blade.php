<form action="{{isset($route)?$route:route('dashboard.faq.store')}}" method="POST">
    {{csrf_field()}}
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control {{ $errors->has('question') ? ' is-invalid' : '' }}" name="question" id="question" value="" placeholder="" maxlength="255" required="required" >
