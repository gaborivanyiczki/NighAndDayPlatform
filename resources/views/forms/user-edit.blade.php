<form action="{{isset($route)?$route:route('dashboard.user.update.profile')}}" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control {{ $errors->has('firstname') ? ' is-invalid' : '' }}" name="firstname" id="firstname" value="{{old('firstname', $model->firstname)}}" placeholder="" maxlength="255" required="required" >
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control {{ $errors->has('lastname') ? ' is-invalid' : '' }}" name="lastname" id="lastname" value="{{old('lastname', $model->lastname)}}" placeholder="" maxlength="255" required="required" >
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control {{ $errors->has('telephone') ? ' is-invalid' : '' }}" name="telephone" id="telephone" value="{{old('telephone', $model->telephone)}}" placeholder="" maxlength="255" required="required" >
