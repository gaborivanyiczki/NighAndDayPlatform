        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="page-header-left">
                    <h3>Editare Brand
                        <small>Editeaza brandul aleas de tine.</small>
                    </h3>
                </div>
            </div>
            <div class="col-lg-6">
                <ol class="breadcrumb pull-right">
                    ...
                    <li class="breadcrumb-item active">Editeaza brand</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    @include('forms.brand',['route'=>route('dashboard.brands.update'),'method'=>'POST'])
                </div>
            </div>
        </div>
    </div>
