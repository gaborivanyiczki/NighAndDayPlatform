        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="page-header-left">
                    <h3>Configuratii platforma
                        <small>Configuratiile curente ale platformei</small>
                    </h3>
                </div>
            </div>
            <div class="col-lg-6">
                <ol class="breadcrumb pull-right">
                    ...
                    <li class="breadcrumb-item active">Lista configuratii platforma</li>
                </ol>
            </div>
        </div>
    </div>
