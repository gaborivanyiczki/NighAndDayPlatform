        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="page-header-left">
                    <h3>Creeaza Voucher
                        <small>Creeaza voucherul ales de tine.</small>
                    </h3>
                </div>
            </div>
            <div class="col-lg-6">
                <ol class="breadcrumb pull-right">
                    ...
                    <li class="breadcrumb-item active">Creeaza voucher</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    @include('forms.voucher-create',['route'=>route('dashboard.vouchers.store'),'method'=>'POST'])
                </div>
            </div>
        </div>
    </div>
